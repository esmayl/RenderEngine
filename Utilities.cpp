...
bool Utilities::CreateVertexShader(ID3D11Device* device, HRESULT& hr, const wchar_t* vsFilePath, ID3D11VertexShader** vertexShader, ID3DBlob** vsBlob)
{
...
bool Utilities::CreatePixelShader(ID3D11Device* device, HRESULT& hr, const wchar_t* psFilePath, ID3D11PixelShader** pixelShader)
{
	// Already compiled by msbuild
...
bool Utilities::CreateComputeShader(ID3D11Device* device, HRESULT& hr, const wchar_t* csFilePath, ID3D11ComputeShader** computeShader)
{
	// Already compiled by msbuild
